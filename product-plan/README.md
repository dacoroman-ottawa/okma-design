# KanataMusicAcademy — Design Handoff

This folder contains everything needed to implement KanataMusicAcademy.
...
- `instructions/incremental/` — 7 milestone instructions (foundation, then sections)
